...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "EventScape Studio — Plan · Organize · Create · Celebrate" },
      ...
      { name: "author", content: "EventScape Studio" },
      { property: "og:title", content: "EventScape Studio" },
      { property: "og:description", content: "Plan, organize, and celebrate your events with an elegant all-in-one workspace." },
